Locales['fr'] = {
  ...
  ['ambulance_wear'] = 'Tenue Ambulance',
  ['mems_clothes_ems'] = 'Tenue Ambulance Homme',
  ['fems_clothes_ems'] = 'Tenue Amnulance Femme',
  ...
  ['armory'] = 'Casier Equipement',
  ['open_armory'] = 'appuez sur ~INPUT_CONTEXT~ pour accéder à l\'equipement',
  -- Vehicles
